...
add_action( 'admin_menu', function()  {
    add_menu_page( 'Maintenance Mode', 'Maintenance Mode', 'manage_options', plugin_dir_path( __FILE__ ) .'/ns_admin_option_dashboard.php', '', plugin_dir_url( __FILE__ ).'img/backend-sidebar-icon.png', 60);
...
/* *** *********************************************************************** *** */
/* *** add menu page and add sub menu page *** */
function ns_mm_preprocess_pages($value){
    global $pagenow;
...
add_action('admin_init', 'ns_mm_preprocess_pages');

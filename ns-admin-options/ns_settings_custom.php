...
if($ns_img == '')
	$ns_img = plugin_dir_url(__FILE__).'img/1.jpg';
$ns_type = get_option('ns-maintenance-type', 0);
?>
...
<div class="ns-ctbc-section-container">
	...
	<div>
		<input id="ns_mm_background_image" class="ns-upload-text " name="ns_mm_background_image" type="text" size="36" value="<?php echo $ns_img; ?>" />
...
<?php 
submit_button();
settings_fields('ns_mm_options_group'); 
?>